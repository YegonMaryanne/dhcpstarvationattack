...
class DHCPClient: 
	def __init__(self):
		...
		# normally Scapy makes sure that replies come from the same IP address the stimulus was sent to, 
    # if our DHCP packet was set to the IP broadcast address then any answer packet will have the IP address of the replying DHCP server as its source IP address
